...
<body>
    <nav id="menu">
        <div class="container">
            <h1><a href="#menu">Mobile Game Store</a></h1>
            <div></div>
            <ul>
            ...
            <div class="wrapper">
                <div class="footer">
                    ...
                    <div class="footer-section">
                        <h3>Partnership</h3>
                        <ul>
                            <li><a class="text-white" href="https://www.ulbi.ac.id/">Universitas Logistik dan Bisnis Internasional</a></li>
                            <li><a class="text-white" href="https://if.ulbi.ac.id/">Prodi Teknik Informatika</a></li>
                            <li><a class="text-white" href="https://www.instagram.com/himatifpoltekpos_/?hl=id">HIMATIF</a></li>
                            <li><a class="text-white" href="https://www.instagram.com/logic_coffeee/?hl=id">Logic Coffee</a></li>
