            ...
            <form action="" method="post" class="mt-5 d-flex flex-column justify-content-center align-items-center">
                <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><input type="text" placeholder="isi jumlah_diamond..." value="250"  name="jumlah_diamond" id="jumlah_diamond" require class="form-control"></td>
                    </tr>
                    <tr>
                        <td><label for="harga">Harga</label></td>
                        <td>:</td>
                        <td><input type="harga" placeholder="isi harga...."  value="50000" name="harga" id="harga" require class="form-control"></td>
                    </tr>
                    <tr>
