...
$rows = query("SELECT * FROM pengelola WHERE id = $id")[0];
            ...
            <form action="" method="post" class="mt-5 d-flex flex-column justify-content-center align-items-center">
                <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><input type="text" placeholder="isi id game....." value="<?= $rows["game"] ?>" name="game" id="game" require class="form-control"></td>
                    </tr>
                    <tr>
                        <td><label for="id_game">ID Game</label></td>
                        <td>:</td>
                        <td><input type="number" placeholder="isi id game....." name="id_game" id="id_game" require class="form-control" value="<?= $rows["id_game"] ?>"></td>
                    </tr>
                    <tr>
                        <td><label for="username">Username Game</label></td>
                        <td>:</td>
                        <td><input type="text" placeholder="isi username ......" name="username_game" id="username" require class="form-control" value="<?= $rows["username"] ?>" ></td>
                    </tr>
                    <tr>
                        <td><label for="jumlah_diamond">Jumlah Diamond</label></td>
                        <td>:</td>
                        <td><input type="text" placeholder="isi jumlah_diamond..." value="<?= $rows["diamond"] ?>" name="jumlah_diamond" id="jumlah_diamond" require class="form-control"></td>
                    </tr>
                    <tr>
                        <td><label for="harga">Harga</label></td>
                        <td>:</td>
                        <td><input type="harga" placeholder="isi harga...." value="<?= $rows["pembayaran"] ?>" name="harga" id="harga" require class="form-control"></td>
                    </tr>
                    <tr>
                        <td><label for="tanggal">Tanggal Pembayaran</label></td>
                        <td>:</td>
                        <td><input type="date" placeholder="isi tanggal.." name="tanggal" id="tanggal" require class="form-control" value="<?= $rows["tanggal_pembayaran"] ?>"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <!-- <td><a href="index.php" class=" btn-primary"><i class="fa-solid fa-backward"></i></a></td> -->
                        <td></td>
                        <td><button type="submit" name="submit" class="btn btn-dark">EDIT</button></td>
                    </tr>
                </table>
            </form>
            </form>
